...
(task-options!
  pom {:project     'topixim/floating
       :version     +version+
       :description "Floating"
       :url         "https://github.com/TopixIM/floating"
       :scm         {:url "https://github.com/TopixIM/floating"}
...
(deftask dev! []
  ...
  (comp
    ...
    (reload :on-jsload 'floating.core/on-jsload
            :cljs-asset-path ".")
...
(deftask rsync []
  (with-pre-wrap fileset
    (sh "rsync" "-r" "target/" "tiye.me:repo/Cumulo/floating" "--exclude" "main.out" "--delete")
    fileset))
